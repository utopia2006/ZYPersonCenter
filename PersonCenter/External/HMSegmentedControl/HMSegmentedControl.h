...
@property (nonatomic, strong) NSMutableArray *sectionBadges;
...
/**
 badge image to display
 */
@property (nonatomic, strong) UIImage *badgeImage;

- (id)initWithSectionTitles:(NSArray *)sectiontitles;
- (id)initWithSectionTitles:(NSArray *)sectiontitles sectionBadges:(NSArray *)sectionBadges;
